...
| 009 | GOAP/dynamic planning vs static graph wiring — the canonical essay | src/main/kotlin/com/renovator/agent/RenovatorAgent.kt:14 | GOAP vs static graph |
| 010 | Action-cost asymmetry: the planner prefers plans that fail cheap | src/main/kotlin/com/renovator/agent/RenovatorAgent.kt:41 | cost asymmetry, fail cheap |
| 011 | The typed blackboard is workflow-engine process variables | src/main/kotlin/com/renovator/agent/RenovatorAgent.kt:62 | typed blackboard = BPMN process variables |
| 012 | @State loops: state scoping and why clearBlackboard = true exists | src/main/kotlin/com/renovator/agent/states/Stages.kt:37 | @State loop semantics |
